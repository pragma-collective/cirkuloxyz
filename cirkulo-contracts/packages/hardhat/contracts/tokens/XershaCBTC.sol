...
contract XershaCBTC is ERC20 {
    ...
    constructor() ERC20("Xersha cBTC", "xshCBTC") {
        owner = msg.sender;
    }
    ...
    function transfer(address, uint256) public pure override returns (bool) {
        revert("xshCBTC: Non-transferable");
    }
